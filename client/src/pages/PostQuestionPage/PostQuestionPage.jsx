...
const PostQuestionPage = () => {
  ...
  const { isLoading, error, performFetch, cancelFetch } = useFetch("/questions/create", (response) => {
  ...
  if (error !== null) {
    statusComponent = <div id="postQuestion-status-component">Error while trying to post question: {error.toString()}</div>;
  }

  if (isLoading) {
    statusComponent = <div id="postQuestion-status-component">Posting question...</div>;
  }
  ...
  return (
    <div id="PostQuestionPage">
      ...
      <h3>Got any bugs? Share your experience and let&apos;s find a solution together.</h3>
      <form id="postQuestionForm" onSubmit={handleSubmit}>
        <div id="postQuestion-input-area">
          <label htmlFor="question-title">
            What would you like to ask about?
            <input name="question-title" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Please enter your question title here." />
          </label>
