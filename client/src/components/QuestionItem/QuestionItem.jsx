...
const QuestionItem = ({ question, isUserQus = false }) => {
  ...
  const { isLoading, error, performFetch, cancelFetch } = useFetch(`/user/userQuestions/delete/${id}`, (res) => {
    console.log(res);
  });
  ...
  return (
    <div className="question-wrapper">
      ...
      <div className="button-group">
        ...
        {isUserQus && (
          <Button className="icon-button delete" onClick={() => setDeleteStarted(true)}>
